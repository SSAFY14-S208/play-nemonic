...
#   /share   — backend 가 /share/:token path 안 만들고 root + share_token query 로 처리.
...
#     [I13 이탈 직전 체류 ───────────────────────]
PANELS = [
    # 섹션 1: 오늘의 KPI — 헤더 h=5 (단일 제목 + 여유 padding)
    ...
    {"vis_id": I7["id"],  "panel_id": "3",
     "grid": {"x": 0,  "y": 20, "w": 24, "h": 18}},
    {"vis_id": I10["id"], "panel_id": "4",
     "grid": {"x": 24, "y": 20, "w": 24, "h": 18}},
    {"vis_id": I8["id"],  "panel_id": "5",
     "grid": {"x": 0,  "y": 38, "w": 24, "h": 18}},
    {"vis_id": I6["id"],  "panel_id": "6",
     "grid": {"x": 24, "y": 38, "w": 24, "h": 18}},

    # 섹션 3: 컨텐츠
    {"vis_id": HEADER_CONTENT["id"], "panel_id": "h3",
     "grid": {"x": 0, "y": 56, "w": 48, "h": 5}},
    {"vis_id": I2["id"],  "panel_id": "7",
     "grid": {"x": 0,  "y": 61, "w": 24, "h": 16}},
    {"vis_id": I5["id"],  "panel_id": "8",
     "grid": {"x": 24, "y": 61, "w": 24, "h": 16}},

    # 섹션 4: 단계·화면 흐름
    {"vis_id": HEADER_FLOW["id"], "panel_id": "h4",
     "grid": {"x": 0, "y": 77, "w": 48, "h": 5}},
    ...
    {"vis_id": HEADER_RETENTION["id"], "panel_id": "h5",
     "grid": {"x": 0, "y": 128, "w": 48, "h": 5}},
    {"vis_id": I9["id"],  "panel_id": "11",
     "grid": {"x": 0,  "y": 133, "w": 24, "h": 18}},
    {"vis_id": I12["id"], "panel_id": "12",
     "grid": {"x": 24, "y": 133, "w": 24, "h": 18}},
    {"vis_id": I13["id"], "panel_id": "13",
     "grid": {"x": 0,  "y": 151, "w": 48, "h": 14}},
]
