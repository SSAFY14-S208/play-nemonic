...
const BIRTH_FORM_FRAME_CLASS = cn(
  ...
  "pt-[clamp(2.9rem,6vw,5rem)] pr-[clamp(2.4rem,5.4vw,4.5rem)] pb-[clamp(5.4rem,9.8vw,7.6rem)] pl-[clamp(2.4rem,5.4vw,4.5rem)]",
  ...
  // mobile overrides
  "max-[800px]:max-h-[calc(100dvh-5.5rem)]",
  "max-[800px]:p-[2.6rem_1.95rem_3.6rem]",
          ...
          >
            ...
            <h1
              className={cn(
                ...
                "text-[clamp(0.95rem,4vw,1.62rem)]",
            ...
            <p
              className={cn(
                "m-0 w-full max-w-[30rem] font-fortune-eulyoo font-normal leading-[1.48] break-keep",
                "text-[clamp(0.78rem,3vw,1.08rem)]",
