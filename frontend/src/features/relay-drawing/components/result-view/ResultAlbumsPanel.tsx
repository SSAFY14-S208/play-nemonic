        ...
        {resultItems.map((resultItem, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                'caption-b grid min-h-22 cursor-pointer place-items-center overflow-hidden rounded-xl border-[1.5px] border-relay-line bg-relay-credit-row text-relay-accent-strong transition-all hover:-translate-y-0.5 hover:brightness-95 disabled:hover:translate-y-0 disabled:hover:brightness-100',
