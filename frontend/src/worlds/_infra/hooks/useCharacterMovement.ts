...
export function useCharacterMovement(
  ...
  useFrame((_, delta) => {
    ...
    characterPositionRef.current.set(translation.x, translation.y, translation.z)
    ...
    const horizontalDistance = Math.sqrt(directionX * directionX + directionZ * directionZ)
    ...
    rigidBody.setNextKinematicTranslation({ x: nextX, y: CHARACTER_Y, z: nextZ })
