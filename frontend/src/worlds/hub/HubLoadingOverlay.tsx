...
export default function HubLoadingOverlay({
  ...
  return (
    <div
      ...
      className={cn(
        'fixed inset-0 z-[80] flex items-center justify-center bg-surface-default',
    ...
    >
      <div className="flex w-[min(21rem,calc(100vw-3rem))] flex-col items-center gap-5 text-center">
        <HubLoadingHouseLottie />
        <div className="flex flex-col items-center gap-2">
          <p className="h3-b text-fg-primary">
            {isReady ? '허브 준비 완료' : statusText}
          </p>
          <p className="caption-m text-fg-secondary">
            방 안의 에셋을 정리하고 있어요
          </p>
        </div>
