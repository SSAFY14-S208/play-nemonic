...
public record CommunityMemoDetailRow(UUID memoId, UUID userId, String authorNickname, UUID artifactId,
    ...
    double positionY, int zIndex, float rotationDeg, String decoration, int reportCount, String moderationStatus,
    LocalDateTime attachedAt, LocalDateTime createdAt, LocalDateTime updatedAt) {
}
