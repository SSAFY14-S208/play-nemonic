package com.nemonicworld.global.logging;
...
/**
 * OpenSearch 로그 파이프라인으로 수집되는 구조화 이벤트 로그를 공통 스키마로 발행합니다.
 */
public final class StructuredEventLogger {
    ...
    public static void apiBusiness(String eventName, Map<String, Object> metadata) {
        emit(API_LOG, "INFO", SERVICE_API, "business_event", eventName, eventName, null, null, null, metadata, null);
    }

    public static void apiBusiness(String eventName, String contentType, String uuid, Map<String, Object> metadata) {
        emit(API_LOG, "INFO", SERVICE_API, "business_event", eventName, eventName, null, contentType, uuid, metadata,
            null);
    }
    ...
    public static void audit(String eventName, Map<String, Object> metadata) {
        audit(eventName, eventName, null, metadata);
    }

    public static void audit(String eventName, String message, String traceId, Map<String, Object> metadata) {
        emit(AUDIT_LOG, "INFO", SERVICE_BACKOFFICE, "audit_event", eventName, message, traceId, null, null, metadata,
            null);
    }

    public static void auditWarn(String eventName, String message, String traceId, Map<String, Object> metadata) {
        emit(AUDIT_LOG, "WARN", SERVICE_BACKOFFICE, "audit_event", eventName, message, traceId, null, null, metadata,
            null);
    }
    ...
    private static void emit(Logger logger, String level, String service, String logType, String eventName,
        String message, String traceId, String contentType, String uuid, Map<String, Object> metadata,
        Throwable error) {
    ...
    private static Object normalizeValue(Object value) {
        ...
        if (value instanceof Collection<?> collection) {
            return collection.stream().map(StructuredEventLogger::normalizeValue).toList();
        }
