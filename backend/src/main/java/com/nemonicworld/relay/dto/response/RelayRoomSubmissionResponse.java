...
public record RelayRoomSubmissionResponse(@Schema(description = "Room code", example = "AB3K9Q") String roomCode,
    ...
    @Schema(description = "Status", example = "SUBMITTED") RelayAssignmentStatus assignmentStatus,
    @Schema(description = "Drawing object key", example = "relay/tmp/AB3K9Q/1/body.png") String drawingObjectKey,
    @Schema(description = "Hint key", nullable = true, example = "relay/tmp/...") String hintObjectKey,
    @Schema(description = "Submitted at", example = "2026-05-05T14:00:31") LocalDateTime submittedAt,
    @Schema(description = "Already submitted", example = "false") boolean alreadySubmitted,
    @Schema(description = "Submitted part completed", example = "false") boolean currentPartCompleted,
    ...
    @Schema(description = "Next start") LocalDateTime nextPartStartedAt,
    @Schema(description = "Next deadline") LocalDateTime nextPartDeadlineAt,
