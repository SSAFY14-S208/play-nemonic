...
public record RelayRoomSubmissionResponse(@Schema(description = "방 코드", example = "AB3K9Q") String roomCode,
    ...
    @Schema(description = "원본 이미지 객체 키", example = "relay/tmp/AB3K9Q/1/body.png") String drawingObjectKey,
    @Schema(description = "힌트 객체 키", nullable = true, example = "relay/tmp/...") String hintObjectKey,
