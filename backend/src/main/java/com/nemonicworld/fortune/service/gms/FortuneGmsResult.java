...
public record FortuneGmsResult(String title, String summary, int overallLuck, int loveLuck, int workLuck, int moneyLuck,
    String luckyColor, String luckyKeyword, String luckyDirection, String caution, String postitLine, String cardTheme,
    String bgColor, String accentColor, String iconKey) {
}
