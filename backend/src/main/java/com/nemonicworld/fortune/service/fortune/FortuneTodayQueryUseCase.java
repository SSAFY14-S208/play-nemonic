...
public class FortuneTodayQueryUseCase {
    ...
    public FortuneTodayQueryUseCase(FortuneTransactionSupport transactionSupport,
        AnonymousUserResolver anonymousUserResolver, FortuneGenerationService fortuneGenerationService,
    ...
    public FortuneResponse getTodayFortune(String userUuidValue) {
        ...
        FortuneDetailRow row = transactionSupport.findTodayFortuneDetail(user.getId(), today)
    ...
    private void ensureCurrentFortuneImage(FortuneDetailRow row, JsonNode description) {
        ...
        transactionSupport.updateFortuneImageObjectKey(row.fortuneId(), expectedObjectKey,
