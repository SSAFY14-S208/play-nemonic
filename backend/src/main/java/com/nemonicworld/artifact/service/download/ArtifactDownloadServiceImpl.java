...
public class ArtifactDownloadServiceImpl implements ArtifactDownloadService {
    ...
    public ArtifactDownloadServiceImpl(ArtifactImageUrlRepository artifactImageUrlRepository,
    ...
    public ArtifactDownloadFile prepareDownloadFile(String userUuidValue, String artifactIdValue) {
        ...
        return new ArtifactDownloadFile(artifactDownloadStorage.download(cacheObjectKey), fileName, contentType);
    }
