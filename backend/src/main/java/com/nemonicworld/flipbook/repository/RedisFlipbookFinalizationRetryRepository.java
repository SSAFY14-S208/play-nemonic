...
@Repository
public class RedisFlipbookFinalizationRetryRepository implements FlipbookFinalizationRetryRepository {

    private static final String FINALIZATION_RETRY_KEY_PREFIX = "flipbook:room-finalization-retry:";

    private final StringRedisTemplate redisTemplate;

    public RedisFlipbookFinalizationRetryRepository(StringRedisTemplate redisTemplate) {
