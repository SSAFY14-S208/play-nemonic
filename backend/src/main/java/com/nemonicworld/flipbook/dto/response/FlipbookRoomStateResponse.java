...
public record FlipbookRoomStateResponse(@Schema(description = "공유 방코드", example = "AB3K9Q") String roomCode,
    ...
    public FlipbookRoomStateResponse(String roomCode, FlipbookRoomStatus status, String hostUserUuid,
        ...
        this(roomCode, status, hostUserUuid, timeLimitSeconds, null, minParticipants, maxParticipants, participantCount,
            currentRound, totalRounds, roundStartedAt, roundDeadlineAt, gameStartedAt, participants, viewer, createdAt,
            updatedAt);
    }
    ...
    public FlipbookRoomStateResponse(String roomCode, FlipbookRoomStatus status, String hostUserUuid,
        ...
        LocalDateTime updatedAt) {
        this(roomCode, status, hostUserUuid, timeLimitSeconds, null, minParticipants, maxParticipants, participantCount,
            null, null, null, null, null, participants, viewer, createdAt, updatedAt);
    }
    ...
    public static FlipbookRoomStateResponse from(FlipbookRoomState roomState, FlipbookRoomViewerResponse viewer) {
        return from(roomState, viewer, null);
    }

    public static FlipbookRoomStateResponse from(FlipbookRoomState roomState, FlipbookRoomViewerResponse viewer,
        FlipbookRoomTimeLimitSettings timeLimitSettings) {
        ...
        FlipbookRoomTimeLimitOptionsResponse timeLimitSecondsOptions = timeLimitSettings == null
            ? null
            : FlipbookRoomTimeLimitOptionsResponse.from(timeLimitSettings);
        ...
        return new FlipbookRoomStateResponse(roomState.roomCode(), roomState.status(), roomState.hostUserUuid(),
            ...
            roomState.maxParticipants(), roomState.participantCount(), roomState.currentRound(),
            roomState.totalRounds(), roomState.roundStartedAt(), roomState.roundDeadlineAt(), roomState.gameStartedAt(),
            participantResponses, viewer, roomState.createdAt(), roomState.updatedAt());
    }
}
