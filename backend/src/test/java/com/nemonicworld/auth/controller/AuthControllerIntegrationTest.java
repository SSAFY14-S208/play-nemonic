...
class AuthControllerIntegrationTest extends AbstractReadOnlyIntegrationTest {
    ...
    void prepareAdminUserTable() {
        adminUserFixture = new AdminUserTestFixture(jdbcTemplate, passwordEncoder);
    ...
    private void insertAdminUser(long id, String loginId, String rawPassword, String role, LocalDateTime deletedAt) {
        adminUserFixture.insertRawPassword(id, loginId, rawPassword, ADMIN_NICKNAME, ADMIN_EMAIL, role, deletedAt);
    }
