...
class ArtifactShareServiceImplTest {
    ...
    private static final String QR_IMAGE_URL = "https://minio.example.com/nemonic/artifact-downloads/result-qr-v4.gif";
    ...
    void createArtifactShareReturnsQrImageUrlAndPlatformUrls() {
        ArtifactQrAsset asset = new ArtifactQrAsset(ARTIFACT_ID, "flipbook",
            "artifact-downloads/%s/result-qr-v4.gif".formatted(ARTIFACT_ID), "nemonic-%s.gif".formatted(ARTIFACT_ID),
