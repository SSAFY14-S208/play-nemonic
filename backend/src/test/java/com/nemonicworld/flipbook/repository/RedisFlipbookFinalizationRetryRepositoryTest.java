...
class RedisFlipbookFinalizationRetryRepositoryTest {

    private static final String ROOM_CODE = "FB3K9Q";
    private static final String RETRY_KEY = "flipbook:room-finalization-retry:" + ROOM_CODE;

    private StringRedisTemplate redisTemplate;
    private ValueOperations<String, String> valueOperations;
    private RedisFlipbookFinalizationRetryRepository repository;

    @BeforeEach
    void setUp() {
        redisTemplate = mock(StringRedisTemplate.class);
        valueOperations = createValueOperationsMock();
        repository = new RedisFlipbookFinalizationRetryRepository(redisTemplate);
