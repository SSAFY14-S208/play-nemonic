 ...
 */
class FlipbookRoomQueryControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    private void insertFlipbookRoomTimeLimitSetting(String settingValue) {
        backofficeSettingFixture.insert(11L, "flipbook.room_time_limit_seconds", settingValue, 0L);
    }
