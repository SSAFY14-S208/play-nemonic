...
class CommunityMemoControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    private void insertCommunityMaxMemoCountSetting(int maxMemoCount) {
        backofficeSettingFixture.insert(10L, "community.max_memo_count",
    ...
    private void insertCommunityReportHideThresholdSetting(int threshold) {
        backofficeSettingFixture.insert(11L, "community.report_hide_threshold",
            "{\"value\":%d,\"unit\":\"count\",\"description\":\"커뮤니티 메모 자동 숨김 신고 기준\"}".formatted(threshold), 0L);
    }
    ...
    private void insertCommunityMemo(UUID memoId, UUID userUuid, UUID artifactId, String bodyImageUrl,
        ...
        communityMemoFixture.insertMemo(memoId, userUuid, artifactId, 120.5, 80.0, zIndex, -4.5, decoration,
            bodyImageUrl, thumbnailImageUrl, attachedAt, reportCount, hidden, null, null, moderationStatus, null, null,
    ...
    private void insertMemoReport(UUID memoId, UUID userUuid, String reason, LocalDateTime createdAt) {
        communityMemoFixture.insertReport(memoId, userUuid, reason, null, createdAt);
    }
