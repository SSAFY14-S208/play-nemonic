 ...
 */
class RelayRoomControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    private void insertRelayParticipantLimitSetting(String settingValue) {
        backofficeSettingFixture.insert(10L, "relay.room_participant_limit", settingValue, 0L);
    }
