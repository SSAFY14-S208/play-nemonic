...
class GmsPromptOpenApiIntegrationTest {
    ...
    void gmsPromptPreviewApiIsExposedInOpenApiDocs() throws Exception {
        mockMvc.perform(get("/v3/api-docs")).andExpect(status().isOk())
            ...
            .andExpect(jsonPath("$.components.schemas.GmsPromptPreviewResponse.properties.design").exists()).andExpect(
                jsonPath("$.components.schemas.GmsPromptPreviewResponse.properties.previewImageBase64").exists());
    }
}
