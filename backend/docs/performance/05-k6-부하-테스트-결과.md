...
| 구분 | 경로 |
| --- | --- |
| k6 결과 문서 | `backend/docs/performance/05-k6-부하-테스트-결과.md` |
| k6 실행 가이드 | `backend/docs/performance/06-k6-부하-테스트-실행-가이드.md` |
| k6 공통 summary helper | `backend/scripts/k6/lib/summary.js` |
| k6 결과 폴더 | `backend/docs/performance/k6-results` |
| p95 그래프 | `backend/docs/performance/assets/k6-p95-latency-ko.svg`, `backend/docs/performance/assets/k6-p95-latency.svg` |
| RPS 그래프 | `backend/docs/performance/assets/k6-rps-ko.svg`, `backend/docs/performance/assets/k6-rps.svg` |

## 사용한 k6

| 트러블 슈팅 | 측정 대상 | k6 스크립트 | 결과 파일 |
| --- | --- | --- | --- |
| 트러블 슈팅 1 | 운세 생성 외부 I/O 트랜잭션 분리 | `backend/scripts/k6/fortune-create-load.js` | `backend/docs/performance/k6-results/fortune-create-load.md` |
| 트러블 슈팅 1 | 문의 답변 SMTP 외부 I/O 트랜잭션 분리 | `backend/scripts/k6/admin-inquiry-reply-load.js` | `backend/docs/performance/k6-results/admin-inquiry-reply-load.md` |
| 트러블 슈팅 2 | 갤러리 목록 조회 | `backend/scripts/k6/gallery-list-load.js` | `backend/docs/performance/k6-results/gallery-list-load.md` |
| 트러블 슈팅 3 | 무한캔버스 활성 방 목록 | `backend/scripts/k6/infinite-canvas-active-room-load.js` | `backend/docs/performance/k6-results/infinite-canvas-active-room-load.md` |
