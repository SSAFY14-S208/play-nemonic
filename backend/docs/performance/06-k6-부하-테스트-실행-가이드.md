...
| 트러블 슈팅 5 | 실제 HTTP 부하 테스트 결과 정리 | `backend/docs/performance/05-k6-부하-테스트-결과.md` | p95, p99, RPS, 실패율 |
...
2026-06-01 로컬 통제 환경에서 실행한 결과 요약은 `backend/docs/performance/05-k6-부하-테스트-결과.md`에 정리했습니다.
