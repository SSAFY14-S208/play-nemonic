...
1. 각 트러블 슈팅 상세 문서의 `사용한 k6` 섹션에서 k6 결과 요약을 먼저 봅니다.
2. 이 폴더의 개별 결과 파일에서 실행 조건, p95, p99, RPS, 실패율 원본을 확인합니다.
3. k6를 다시 실행할 때는 `backend/docs/performance/k6-실행-가이드.md`를 봅니다.
