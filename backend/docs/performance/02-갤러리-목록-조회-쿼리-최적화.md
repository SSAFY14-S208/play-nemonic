...
| 구분 | 경로 |
| --- | --- |
| 최적화 문서 | `backend/docs/performance/02-갤러리-목록-조회-쿼리-최적화.md` |
...
| k6 스크립트 | `backend/scripts/k6/gallery-list-load.js` |
| k6 결과 파일 | `backend/docs/performance/k6-results/gallery-list-load.md` |
| k6 결과 요약 | `backend/docs/performance/05-k6-부하-테스트-결과.md` |
| 그래프 assets | `backend/docs/performance/assets/gallery-query-count-p95-ko.svg`, `backend/docs/performance/assets/gallery-query-list-p95-ko.svg`, `backend/docs/performance/assets/gallery-query-subtype-lookup-ko.svg` |
...
| --- | --- | --- | --- |
| 갤러리 목록 조회 | `backend/scripts/k6/gallery-list-load.js` | `gallery_list` | `backend/docs/performance/k6-results/gallery-list-load.md` |
...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 10,745 | 268.54 | 14.27ms | 19.96ms | 26.69ms | 0.00% |
