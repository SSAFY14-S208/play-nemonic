...
- Relay room join/reconnect now uses `POST /api/v1/relay/rooms/{roomCode}/participants`, performs Redis read-modify-save for new WAITING-room participants or 10-second reconnects, and remains free of PostgreSQL artifact/gallery, MinIO, and WebSocket side effects.
