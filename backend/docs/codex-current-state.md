...
- `CommunityMemoImageUrlResolver` converts direct community memo MinIO object keys into public renderable URLs using configured `publicUrl` and `bucket`, without MinIO existence checks or presigned URL issuance.
