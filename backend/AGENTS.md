...
Use this guide as the backend operating manual for Codex and other coding agents.
...
- Local infrastructure compose file: `backend/docker-compose.local.yml`
- Flyway migrations: `backend/src/main/resources/db/migration`
- Team contribution guide: `backend/CONTRIBUTING.md`
...
- Treat root `AGENTS.md`, this file, and `backend/docs/codex-current-state.md` as the baseline for new sessions.
...
- Follow `backend/CONTRIBUTING.md` for branch, commit, Jira, and MR conventions.
